...
C  MERGE TWIGS AND BRANCHES
  ...
  750 CONTINUE
      DO 760 J3=1,NSOVAR
      JJ3 = VARPOS(J3) + OFFSET - 1
      NNL1 = NN(L1) + JJ3
      NNL2 = NN(L2) + JJ3
      IF (VARLEN(J3).NE.0) GO TO 756
      J2 = SWVACP(BUFFER(NN(L1)),BUFFER(NN(L2)),J3)
      GO TO 755
  756 CONTINUE
      KGOTO = VARTYP(J3)
      GO TO (751,752,753,754),KGOTO
  751 J2 = SWIICP(BUFFER(NNL1),BUFFER(NNL2),VARLEN(J3))
      GO TO 755
  752 J2 = SWIRCP(BUFFER(NNL1),BUFFER(NNL2),VARLEN(J3))
      GO TO 755
  753 J2 = SWIDCP(BUFFER(NNL1),BUFFER(NNL2),VARLEN(J3))
      GO TO 755
  754 J2 = SWITCP(BUFFER(NNL1),BUFFER(NNL2),VARLEN(J3))
  755 CONTINUE
